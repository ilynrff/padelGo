...
function StatCard({ item }: { item: StatItem }) {
  ...
  return (
    <div
      className={`bg-white rounded-2xl border ${c.border} shadow-sm p-5 flex items-center gap-4`}
    >
      <div
        className={`w-12 h-12 rounded-2xl ${c.bg} ${c.text} flex items-center justify-center shrink-0`}
      >
        {item.icon}
      </div>
        ...
        {activeTab === "schedule" && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-slate-500 font-medium mt-1">
                Cek ketersediaan lapangan dan atur booking dengan mudah
              </p>
            </div>
            <CourtSchedule />
          </div>
        ...
        {activeTab === "courts" && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-slate-500 font-medium mt-1">
                Kelola lapangan padel dengan mudah — tambah, ubah, atau hapus sesuai kebutuhan
              </p>
            </div>
            <CourtManager />
          </div>
